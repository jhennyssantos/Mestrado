...
plot "plotsrc1seg.dat" using 1:2  title "Cliente 1" with lines ls 1,\
\
"plotsrc2seg.dat" using 1:2  title "Cliente 2" with lines ls 2,\
\
"plotsrc3seg.dat" using 1:2  title "Cliente 3" with lines ls 3,\
#1 / 0 notitle  smooth csplines with lines ls 1
