...
set title "Seleção de Rotas - Largura de banda de 100MBits"
set xlabel "Tempo (ms)"
...
plot "rsc1plotbufferlevel.dat" using 1:2  title "Cliente 1" with lines ls 1,\
\
"rsc2plotbufferlevel.dat" using 1:2  title "Cliente 2" with lines ls 2,\
\
"rsc3plotbufferlevel.dat" using 1:2  title "Cliente 3" with lines ls 3,\
#1 / 0 notitle  smooth csplines with lines ls 1
