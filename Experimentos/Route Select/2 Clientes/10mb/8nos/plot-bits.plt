...
#urban_pdr.dat
#urban_pdr.dat
#plot "plotbufferlevel.dat" using 1:2:4:5  title "Cliente 1" with linespoints ls 1,\
#"plotbufferlevel.dat" using 1:2:4:5 notitle w yerrorbars ls 1,\
#1 / 0 notitle  smooth csplines with lines ls 1

plot "src1plotbufferlevel.dat" using 1:2  title "Cliente 1" with lines ls 1,\
\
"src2plotbufferlevel.dat" using 1:2  title "Cliente 2" with lines ls 2,\
