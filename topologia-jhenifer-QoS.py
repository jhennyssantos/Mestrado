...
<<<<<<< HEAD
    ...
    h1.cmd("ip neigh replace 10.0.0.3 lladdr 00:00:00:00:00:03 dev h1-eth0")
    h3.cmd("ip neigh replace 10.0.0.1 lladdr 00:00:00:00:00:01 dev h3-eth0")
    h3.cmd("ip neigh replace 10.0.0.4 lladdr 00:00:00:00:00:04 dev h3-eth0")
    h4.cmd("ip neigh replace 10.0.0.3 lladdr 00:00:00:00:00:03 dev h4-eth0")
    h3.cmd("ip neigh replace 10.0.0.5 lladdr 00:00:00:00:00:05 dev h3-eth0")
    h5.cmd("ip neigh replace 10.0.0.3 lladdr 00:00:00:00:00:03 dev h5-eth0")
    h3.cmd("ip neigh replace 10.0.0.6 lladdr 00:00:00:00:00:06 dev h3-eth0")
    h6.cmd("ip neigh replace 10.0.0.3 lladdr 00:00:00:00:00:03 dev h6-eth0")

    
    h1.cmd("ip neigh replace 10.0.0.2 lladdr 00:00:00:00:00:02 dev h1-eth0")
    h2.cmd("ip neigh replace 10.0.0.1 lladdr 00:00:00:00:00:01 dev h2-eth0")
   

    h2.cmd("ip neigh replace 10.0.0.4 lladdr 00:00:00:00:00:04 dev h2-eth0")
    h4.cmd("ip neigh replace 10.0.0.2 lladdr 00:00:00:00:00:02 dev h4-eth0")

    h2.cmd("ip neigh replace 10.0.0.3 lladdr 00:00:00:00:00:03 dev h2-eth0")
    h3.cmd("ip neigh replace 10.0.0.2 lladdr 00:00:00:00:00:02 dev h3-eth0")

    h2.cmd("ip neigh replace 10.0.0.5 lladdr 00:00:00:00:00:05 dev h2-eth0")
    h5.cmd("ip neigh replace 10.0.0.2 lladdr 00:00:00:00:00:02 dev h5-eth0")

    h2.cmd("ip neigh replace 10.0.0.6 lladdr 00:00:00:00:00:06 dev h2-eth0")
    h6.cmd("ip neigh replace 10.0.0.2 lladdr 00:00:00:00:00:02 dev h6-eth0")


    h1.cmd("ip neigh replace 10.0.0.5 lladdr 00:00:00:00:00:05 dev h1-eth0")
