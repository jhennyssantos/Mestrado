...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def novarota(self, client_ip):
        ...
        if client_ip == "10.0.0.1":
            # oldpath = sw1 <-> sw3 <-> sw2
            # newpath = sw1 <-> sw8 <-> sw7 <-> sw6 <-> sw5 <-> sw4 <-> sw3 <-> sw2
            print "Modifica fluxos do no 1"
            newpath = [1,8,7,6,5,4,2]
            ...
            newpath = [3,1,8,7,6,5,4,2]
            src = "00:00:00:00:00:03"
            dst = "00:00:00:00:00:02"
            self.modifica_fluxos(src, dst, newpath)
            
            # oldpath = sw3 <-> sw2
            # newpath = sw3 <-> sw1 <-> sw8 <-> sw7 <-> sw6 <-> sw5 <-> sw4 <-> sw2
        
        elif client_ip == "10.0.0.4":
            
            print "modifica fluxos do no 4"
            newpath = [4,5,6,7,8,1,3,2]
            src = "00:00:00:00:00:04"
            dst = "00:00:00:00:00:02"
            self.modifica_fluxos(src, dst, newpath)

            # oldpath = sw4 <-> sw2
            # newpath = sw4 <-> sw5 <-> sw6 <-> sw7 <-> sw8 <-> sw1 <-> sw3 <-> sw2

        elif client_ip == "10.0.0.5":
            
            print "modifica fluxos do no 5"
            newpath = [5,6,7,8,1,3,2]
            src = "00:00:00:00:00:05"
            dst = "00:00:00:00:00:02"
            self.modifica_fluxos(src, dst, newpath)

            # oldpath = sw5 <-> sw4 <-> sw2
            # newpath = sw5 <-> sw6 <-> sw7 <-> sw8 <-> sw1 <-> sw3 <-> sw2
            ...
            # newpath = sw6 <-> sw7 <-> sw8 <-> sw1 <-> sw3 <-> sw2 
            ...
            # oldpath = sw8 <-> sw1 <-> sw3 <-> sw2
            # newpath = sw8 <-> sw7 <-> sw6 <-> sw5 <-> sw4 <-> sw2
